...
def get_prediction(radiant, dire):
    ...
    return [
        {"Radiant": prediction[0][1], "Dire": prediction[0][0], "Time": 1},
        {"Radiant": prediction[1][1], "Dire": prediction[1][0], "Time": 2},
        {"Radiant": prediction[2][1], "Dire": prediction[2][0], "Time": 3},
        {"Radiant": prediction[3][1], "Dire": prediction[3][0], "Time": 4},
        {"Radiant": prediction[4][1], "Dire": prediction[4][0], "Time": 5},
        {"Radiant": prediction[5][1], "Dire": prediction[5][0], "Time": 6},
        {"Radiant": prediction[6][1], "Dire": prediction[6][0], "Time": 7},
        {"Radiant": prediction[7][1], "Dire": prediction[7][0], "Time": 8},
    ]
